...
<html lang="en" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" href="lib_inc/css/footer.css">
     <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.2/css/all.min.css"/>
   </head>
<body>
 <footer style = "margin-top:100px; background-color: blue;">
   <div class="content">
     <div class="left box">
       <div class="upper">
   ...
   <div class="bottom">
     <p>Copyright © 2021 <a href="#">Bhaskar Tiwari</a> All rights reserved</p>
   </div>
 </footer>
